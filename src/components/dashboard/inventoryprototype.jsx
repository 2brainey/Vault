...
const BankInterface = ({ slots, balance, onDragStart, onDrop, onContextMenu, onCurrencyAction }) => (
    <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 bg-black/20 rounded-lg border border-slate-800/50 p-2 mx-4 mb-4 overflow-hidden relative"><InventoryGrid slots={slots} containerId="bank" onDragStart={onDragStart} onDrop={onDrop} onContextMenu={onContextMenu} mp={0} /></div>
    </div>
);
      ...
      <div className="lg:w-1/3 flex flex-col gap-6 h-full overflow-hidden">
        <div className="bg-[#1e1e1e] border border-slate-700 rounded-xl p-6 flex-1 flex flex-col shadow-2xl relative overflow-hidden group">
            <div className="flex justify-between items-center mb-4 relative z-10 shrink-0">
                <div className="flex items-center gap-2 mb-2"><h3 className="text-xl font-bold text-white flex items-center gap-2"><RenderIcon name="Package" className="text-amber-500"/> Backpack</h3></div>
