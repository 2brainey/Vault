              ...
              >
                  {item && (
                    <>
                        ...
                        <div className="absolute bottom-[110%] left-1/2 -translate-x-1/2 w-40 bg-[#0a0a0a] p-2 rounded border border-slate-700 text-xs shadow-2xl hidden group-hover:block z-50 pointer-events-none">
